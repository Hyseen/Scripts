...
;(async () => {
  ...
  let subPolicies = await getSubPolicies(policyName).catch(error => {
    console.log(error)
  ...
  let { fullAvaliablePolicies, originalAvaliablePolicies } = await testPolicies(subPolicies)
  $.setval(JSON.stringify(fullAvaliablePolicies), 'Helge_0x00.Netflix_Full_Avaliable_Policies')
  $.setval(JSON.stringify(originalAvaliablePolicies), 'Helge_0x00.Netflix_Original_Avaliable_Policies')
})()
  .catch(error => {
    console.log(error)
  })
